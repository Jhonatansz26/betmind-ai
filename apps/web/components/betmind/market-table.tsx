import { ArrowUpRight, Check, Minus, ShieldAlert } from 'lucide-react'
...
interface MarketTableProps { rows: MarketRow[]; selectedKey?: string | null; onSelect?: (key: string) => void }
