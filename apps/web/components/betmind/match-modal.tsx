...
function buildDetail(match: Match, enriched: EnrichedMatch | null, model: MatchModel): MatchDetailData {
  ...
  const cornersEv = evAnalysis.find(e => e.market === 'CORNERS_OVER_8_5')
  const cardsEv = evAnalysis.find(e => e.market === 'CARDS_OVER_4_5')
  ...
  const cardsLineDefault = cardsNarr?.line as number | undefined
    ?? cardsEv?.odds
    ?? 3.5
